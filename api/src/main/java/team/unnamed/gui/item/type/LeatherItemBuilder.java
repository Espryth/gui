...
import team.unnamed.gui.item.LeatherArmorColor;

import static team.unnamed.validate.Validate.state;

public class LeatherItemBuilder extends AbstractItemBuilder<LeatherItemBuilder> {
    ...
    @Override
    protected LeatherItemBuilder self() {
        return this;
    }
