...
import team.unnamed.gui.item.ItemFlag;
...
abstract class AbstractItemBuilder<T extends ItemBuilder>
    ...
    protected AbstractItemBuilder(Material material, int amount, short data) {
